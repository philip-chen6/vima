...
**Narrate:**
> "Across 30 frames of real site footage: 86.7% productive. Mean confidence 0.939. ECE calibration 0.0121 — that's a well-calibrated classifier on real-world data. This is the number that feeds the raffle."
