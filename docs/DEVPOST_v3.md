...
**Calibration under class imbalance.** Real masonry footage is mostly productive — 86.7% P in 30 frames. Getting a reliable classifier on heavily imbalanced data required careful confidence thresholding in the prompt and explicit reasoning chain requirements, not just output labels.
